...
const ukTranslations: Record<string, string> = {
  ...
  'Generate reminders': 'Згенерувати нагадування',
  'Generating...': 'Генерація...',
  'Created reminders': 'Створено нагадувань',
  'No new reminders needed.': 'Нові нагадування не потрібні.',
  'Unable to generate reminders.': 'Не вдалося згенерувати нагадування.',
